...
int main() {
    ...
    const char *names[ITEMS] = {
        "Nike Air Max 270", "Nike Air Force 1", "Nike Dunk Low", "Nike React Element 55",
        "Nike Air Zoom Pegasus", "Nike Jordan 1", "Nike Blazer Mid", "Nike Cortez", "Nike Air Max 90"
    };
    int prices[ITEMS] = {3000000, 2000000, 2200000, 1100000, 2500000, 1200000, 2200000, 1500000, 1000000};
    ...
    while (attempts < 3) {
        ...
        if (strcmp(username, "niker") == 0 && strcmp(password, "1234") == 0) {
    ...
    printf("%s=========================================%s\n", BLUE, RESET);
    printf("  Selamat Datang di Toko nike only\n");
    printf("%s=========================================%s\n\n", BLUE, RESET);
    ...
    while (lanjut == 'y' || lanjut == 'Y') {
        // Tampilkan Tabel
        printf("\n%s-------------------------------------------------------------------------------%s\n", BLUE, RESET);
        printf("| %-2s | %-30s | %-13s   | %-6s | %-10s |\n", "No", "Nama sepatu", "Harga", "Stok", "Status");
        printf("-------------------------------------------------------------------------------\n");
        for (int i = 0; i < ITEMS; i++) {
            char hargaFmt[32];
    ...
    if (total >= 3000000.0f) diskon_tier = 0.15f;
    else if (total >= 2500000.0f) diskon_tier = 0.10f;
    else if (total >= 2000000.0f) diskon_tier = 0.05f;
    ...
    while (1) {
        ...
        if (strcmp(metode, "cash") == 0) {
            ...
            adminFee = subtotal_after_all_discounts * 0.0f;
            printf("%sAdmin QRIS (0%%): Rp %.0f%s\n", YELLOW, adminFee, RESET);
    ...
    printf("\n%s======================================================================%s\n", BLUE, RESET);
    printf("                        STRUK PEMBAYARAN TOKO Nike Only\n");
    printf("======================================================================\n\n");
    ...
    if (fstruk) {
        fprintf(fstruk, "======================================================================\n");
        fprintf(fstruk, "                        STRUK PEMBAYARAN TOKO Nike Only\n");
        fprintf(fstruk, "======================================================================\n\n");
